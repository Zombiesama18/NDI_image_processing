...
def init_wandb():
    ...
    wandb.init(project="Sperated-Categories-Angles", name='Test-thrid-time-gamma-3.5-sqrt-class-weights', config={'random_seed': current_seed})
...
print(train_set.weights)
class_criterion = focal_loss(train_set.weights, 3.5, device=device, dtype=torch.double)
