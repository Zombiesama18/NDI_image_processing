...
def main():
    ...
    test_list = ['DSWD', 'DGSWD', 'MSWD', 'MGSWD', 'SWD', 'GSWD']
    ...
    for test_item in test_list:
        ...
        for i, images in enumerate(k_fold_train_validation_split(ORIGINAL_IMAGE, TARGET_IMAGE, 7)):
            wandb.init(project=args.message_to_log, group=f'WDs_cel_Test_again',
                       job_type=f'{wd_name}_{wd_stage}_cel_{cel_stage}_bs_16',
